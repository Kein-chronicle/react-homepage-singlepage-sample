...
function Content() {
    ...
    return (
        <div id="slider6" className="sliderSide" style={{ height:useWindowSize().height, backgroundColor:'white', backgroundImage:`url(${BlackBack})`, backgroundRepeat:'no-repeat', backgroundSize:'cover'}} >
            <div style={{display:'flex', flexDirection:'column', height:useWindowSize().height, backgroundImage:`url(${Eyedocproitem})`, backgroundRepeat:'no-repeat', backgroundPosition:'100% 100%', backgroundSize:'50% auto'}}> 
            {/*  */}
                ...
                <div style={{display:'flex', flex:"7", flexShrink:"1"}}>
                    ...
                    <div style={{display:'flex', flexDirection:'column', flex:"7", flexShrink:"1"}}>
                        ...
                        <div style={{display:'flex', height:'44px', fontSize:'20px'}} >
                            ...
                            <a onClick={(e)=>{menuClick(e, "slider6")}} style={{fontSize:"17px", height:"44px", display:'flex', flexDirection:'column', color:'#0078FF', marginLeft:"32px"}}>
                                <div style={{flex:'1'}} />
                                <div>아이닥 라이트</div>
                                <div style={{flex:'1'}} />
                            </a>
