    ...
    return (
        <div id="content2" style={{backgroundImage:`url(${Image1})`, backgroundRepeat:'no-repeat', backgroundSize:'cover'}}>
            <div className="container">
              ...
              <div style={{textAlign:'left', marginTop:'100px', marginLeft:'100px', color:'rgba(255,255,255,0.6)'}}>
              ...
              <div style={{marginTop:'150px', paddingBottom:'150px'}}>
                  <div style={{textAlign:'left', color:'rgba(255,255,255,0.9)', fontSize:'30px', marginLeft:'100px', paddingBottom:'30px'}}>엠투에스의 구성원들 모두 주인공이자 회사 미래입니다.</div>
                <MemberViewWrap />
              </div>
            </div>
        </div>
