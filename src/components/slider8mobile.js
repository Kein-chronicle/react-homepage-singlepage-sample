...
function Content() {
    ...
    return (
        <div id="slider3" className="sliderSide" style={{ height:useWindowSize().height, backgroundImage:`url(${GrayBack})`, backgroundRepeat:'no-repeat', backgroundSize:'cover'}} >
            <div style={{display:'flex', flexDirection:'column', height:useWindowSize().height, backgroundImage:`url(${VrorHmd})`, backgroundRepeat:'no-repeat', backgroundPosition:'100% 70%', backgroundSize:'70% auto'}}> 
            {/*  */}
                ...
                <div style={{display:'flex', flex:"7", flexShrink:"1"}}>
                    ...
                    <div style={{display:'flex', flexDirection:'column', flex:"7", flexShrink:"1"}}>
                        ...
                        <div style={{display:'flex', fontSize:'20px'}} >
                            ...
                            <a  onClick={(e)=>{menuClick(e, "slider3")}} style={{fontSize:"17px", height:"44px", display:'flex', flexDirection:'column', color:'#4CCD94', marginLeft:"32px", textAlign:'left'}}>
                                <div style={{flex:'1'}} />
                                <div>전정신경계</div>
                                <div style={{flex:'1'}} />
                            </a>
                        ...
                        <div style={{height:'46px', textAlign:'left', fontSize:'20px', color:'black'}}>
                            VR을 이용한 안진 검사기
                        </div>
                        <div style={{flex:"1", textAlign:'left', paddingTop:'20px', paddingBottom:'20px'}}>
                            <img src={Vrvng} style={{ width:"80%" }} />
                        </div>
