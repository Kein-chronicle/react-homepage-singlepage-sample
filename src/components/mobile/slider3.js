...
import Back3 from '../../assets/back16.png'
import Back4 from '../../assets/back4.png'
import Back5 from '../../assets/back5.png'
import Eyeback from '../../assets/back15.png'
        ...
        <div className="sliderSide" style={{height:useWindowSize().height}}>
            <div id="carouselExampleCaptions" className="carousel slide" data-ride="carousel" style={{height: "100%"}}>
                <div className="carousel-inner" style={{height:"100%"}}>
                    <div className="carousel-item active" data-interval="50000">
                        ...
                        <div className="carousel-caption d-md-block" style={{right:'0px', left:'0px',width:'100%',height:'100%',bottom:'0px', top:'0px'}}>
                            <div style={{display:"flex", flexDirection:'column', height:'100%'}}>
                                ...
                                <div>
                                    <div style={{fontSize:'28px'}}>쉽고 간편한 눈<br></br>건강 체크 솔루션</div>
                                    <img src={Logo} style={{width:useWindowSize().width / 2, padding:'20px'}} />
                                </div>
                                <div style={{flex:'1'}}></div>
                            </div>
                        </div>
                        ...
                        <div className="carousel-caption d-md-block" style={{right:'0px', left:'0px',width:'100%',height:'100%',bottom:'0px', top:'0px'}}>
                            <div style={{display:"flex", flexDirection:'column', height:'100%'}}>
                                ...
                                <div style={{display:'flex'}}>
                                    <div style={{flex:'2'}}>
                                    <div style={{fontSize:'32px'}}>"눈은 건강의<br></br>척도입니다."</div>
                                    </div>
                    ...
                    <div className="carousel-item" data-interval="50000" style={{backgroundImage:`url(${Back4})`, backgroundRepeat:'no-repeat', backgroundSize:'cover', backgroundPositionX:'-200px'}}>
                            ...
                            <div style={{display:"flex", flexDirection:'column', height:'100%'}}>
                                ...
                                <div style={{display:'flex'}}>
                                    <div style={{flex:'2'}}>
                                        ...
                                        <div style={{fontSize:'32px'}}>내일의 건강관리를<br></br> 변화시킬 것 입니다."</div>
                                    </div>
                                </div>
                                <div style={{flex:'1'}}></div>
                            </div>
