...
function Content() {
    ...
    return (
        <div id="slider4" className="sliderSide" style={{ height:useWindowSize().height, backgroundImage:`url(${GrayBack})`, backgroundRepeat:'no-repeat', backgroundSize:'cover'}} >
                ...
                <div style={{display:'flex', flex:"7", flexShrink:"1"}}>
                    ...
                    <div style={{display:'flex', flexDirection:'column', flex:"7", flexShrink:"1"}}>
                        ...
                        <div style={{display:'flex', height:'44px', fontSize:'20px'}} >
                            ...
                            <a onClick={(e)=>{menuClick(e, "slider4")}} style={{fontSize:"17px", height:"44px", display:'flex', flexDirection:'column', color:'#4CCD94', marginLeft:"32px", borderBottom:'1px solid #4CCD94'}}>
                                <div style={{flex:'1'}} />
                                <div>뇌신경계</div>
                                <div style={{flex:'1'}} />
                            </a>
