                    ...
                    <div className="carousel-item active" data-interval="5000000" style={{backgroundImage:`url(${Back8})`, backgroundRepeat:'no-repeat', backgroundSize:'cover'}}>
                        ...
                        <div className="carousel-caption d-none d-md-block" style={{right:'0px', left:'0px',width:'100%',height:'100%',bottom:'0px', top:'0px'}}>
                            <div style={{display:"flex", flexDirection:'column', height:'100%'}}>
                                ...
                                <div>
                                    <div style={{display:'flex'}}>
                                        <div style={{flex:'2'}}></div>
                                            <div style={{fontSize:'28px'}}>VR(가상현실)을 이용한 새로운 개념의 안과 검사기</div>
                                        <div style={{flex:'1'}}></div>
                                    </div>
                                ...
                                <div style={{flex:'1'}}></div>
                                <div style={{textAlign:'right', paddingRight:'80px', paddingBottom:'20px', fontSize:'12px', color:'rgba(255,255,255,0.8)'}}>
                                    7가지 안과검사(시야검사, 동공검사, 외안근검사, 랑카스터검사, 입체시검사, 회선검사, 사시각검사)<br />
                        ...
                        <div className="carousel-caption d-none d-md-block" style={{right:'0px', left:'0px',width:'100%',height:'100%',bottom:'0px', top:'0px'}}>
                            <div style={{display:"flex", flexDirection:'column', height:'100%'}}>
                                ...
                                <div>
                                    <div style={{display:'flex'}}>
                                        <div style={{flex:'2'}}></div>
                                            <div style={{fontSize:'28px'}}>뇌병변 진단 및 맞춤형 재활치료기</div>
                                        <div style={{flex:'1'}}></div>
                                    </div>
                                ...
                                <div style={{textAlign:'right', paddingRight:'80px', paddingBottom:'20px', fontSize:'12px', color:'rgba(255,255,255,0.8)'}}>
                                    ...
                                    안구운동추적 및 시야측정기술을 통해 뇌졸증, 뇌경색, 뇌종양, 등의 징후를 미리 파악(골든 타임 확보)
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div style={{display:"flex", flexDirection:'column', height:'100%'}}>
                                ...
                                <div>
                                    ...
                                    <div style={{display:'flex'}}>
                                        <div style={{flex:'1'}}></div>
                                        <div>
                                            <img src={Eyedocpro} style={{width:useWindowSize().width / 5, padding:'20px'}} />
                                        </div>
                                        {/* <div style={{display:'flex', flexDirection:'column'}}>
                                            <div style={{flex:'1'}}></div>
                                            <div style={{fontWeight:'bolder', fontSize:'4rem'}}>
                                                VRVNG
                                            </div>
                                        </div> */}
                                        <div style={{flex:'3'}}></div>
                                ...
                                <div style={{flex:'1'}}></div>
                                <div style={{textAlign:'right', paddingRight:'80px', paddingBottom:'20px', fontSize:'12px', color:'rgba(0,0,0,0.8)'}}>
                            ...
                            <div style={{display:"flex", flexDirection:'column', height:'100%'}}>
                                ...
                                <div>
                                    ...
                                    <div style={{display:'flex'}}>
                                        <div style={{flex:'1'}}></div>
                                        <div>
                                            <img src={Eyedoclitelogo} style={{width:useWindowSize().width / 5, padding:'20px'}} />
                                        </div>
                                        {/* <div style={{display:'flex', flexDirection:'column'}}>
                                            <div style={{flex:'1'}}></div>
                                            <div style={{fontWeight:'bolder', fontSize:'4rem'}}>
