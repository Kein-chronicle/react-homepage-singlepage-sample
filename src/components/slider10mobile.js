...
function Content() {
    ...
    return (
        <div id="slider5" className="sliderSide" style={{ height:useWindowSize().height, backgroundColor:'rgba(246,247,248,1)'}} >
            <div style={{display:'flex', flexDirection:'column', height:useWindowSize().height, backgroundImage:`url(${Eyedocproitem})`, backgroundRepeat:'no-repeat', backgroundPosition:'100% 100%', backgroundSize:'auto 60%'}}> 
            {/*  */}
                ...
                <div style={{display:'flex', flex:"7", flexShrink:"1"}}>
                    ...
                    <div style={{display:'flex', flexDirection:'column', flex:"7", flexShrink:"1"}}>
                        ...
                        <div style={{display:'flex', fontSize:'20px'}} >
                            ...
                            <a onClick={(e)=>{menuClick(e, "slider5")}} style={{fontSize:"17px", height:"44px", display:'flex', flexDirection:'column', color:'#0078FF', marginLeft:"32px", textAlign:'left'}}>
                                <div style={{flex:'1'}} />
                                <div>아이닥 프로</div>
                                <div style={{flex:'1'}} />
                            </a>
