...
function Content() {
    ...
    return (
        <div id="slider2" className="sliderSide" style={{ height:useWindowSize().height, backgroundImage:`url(${Vror7Back})`, backgroundRepeat:'no-repeat', backgroundSize:'cover', backgroundPosition:'60% 100%'}} >
                ...
                <div style={{display:'flex', flex:"7", flexShrink:"1"}}>
                    ...
                    <div style={{display:'flex', flexDirection:'column', flex:"7", flexShrink:"1"}}>
                        ...
                        <div style={{display:'flex', fontSize:'20px'}} >
                            ...
                            <a onClick={(e)=>{menuClick(e, "slider2")}} style={{fontSize:"17px", height:"44px", display:'flex', flexDirection:'column', color:'#4CCD94', marginLeft:"32px", textAlign:'left'}}>
                                <div style={{flex:'1'}} />
                                <div>시신경계</div>
                                <div style={{flex:'1'}} />
                            </a>
